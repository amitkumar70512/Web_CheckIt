...
function sendFeedback(){
    ...
    xhttp.onreadystatechange=function(){
        ...
        else if(this.readyState==2)//header received
        {
    ...
    xhttp.open('POST',`feedback?name=${form.name.value}&email=${form.email.value}&subject=${form.subject.value}+&message=${form.message.value}`,true);
